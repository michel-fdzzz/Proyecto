        ...
        <article class="productos-container">
            ...
            if ($rest->num_rows > 0) {
                foreach ($campos as $campo) {
                    echo
                    "<div class='producto'>
                <a href='producto.php?idProducto=" . $campo[0] . "&nombreProducto=" . $campo[1] . "&modelo=" . $campo[2] . "&precio=" . $campo[4] . "&imagen=" . $campo[5] . "&descripcion=" . $campo[7] . "&stock=" . $campo[6] . "'   target='_blank'> <img src='imagenes/" . $campo[5] . "'  class='producto-imagen'/></a>
                <p>" . $campo[1] . "</p>
                <p>" . intval($campo[4]) . " €</p>
